...
-- ----------------------------
INSERT INTO `input_molding` VALUES (8, '2019-12-14', 'G3-20A002L-1', '22045 (71380)', 'MID BLACK');
...
-- ----------------------------
INSERT INTO `input_molding_detail` VALUES (5, 8, '0001(36)', '36B', 'reguler', 36, 1.118, NULL, NULL, 'OG3-19J033-1-0001', NULL, NULL);
...
-- ----------------------------
INSERT INTO `output_sewing` VALUES (5, '2019-12-16', 'KARIMUN', 2, 8, 12, 7);
INSERT INTO `output_sewing` VALUES (9, '2019-12-16', 'BROMO', 3, 8, 12, 7);
INSERT INTO `output_sewing` VALUES (12, '2019-12-17', 'KARIMUN', 2, 8, 12, 7);
INSERT INTO `output_sewing` VALUES (15, '2019-12-17', 'DIENG', 6, 27, 33, 22);
...
-- ----------------------------
INSERT INTO `output_sewing_detail` VALUES (12, 15, 'G3-20A004L-2', '0001(36)', '11:12:45', '11:12:50', '11:12:54', '11:13:17', 36, 108.756, 50.112, 105.444, 106.812, 'G3-20A004L-2-0001');
INSERT INTO `output_sewing_detail` VALUES (13, 15, 'G3-20A004L-2', '0002(36)', '11:18:22', '11:44:18', '00:00:00', '00:00:00', 36, 108.756, 50.112, 0.000, 0.000, 'G3-20A004L-2-0002');
...
v_input_molding.size,
v_output_molding.total_qty,
v_input_molding.outermold_sam,
v_input_molding.mildmold_sam,
v_input_molding.linningmold_sam,
v_input_molding.outermold_sam_result,
v_input_molding.midmold_sam_result,
v_input_molding.linningmold_sam_result
FROM
v_input_molding
INNER JOIN v_output_molding ON v_output_molding.orc = v_input_molding.orc AND v_output_molding.style = v_input_molding.style
GROUP BY
...
-- ----------------------------
-- View structure for v_daily_packing
-- ----------------------------
DROP VIEW IF EXISTS `v_daily_packing`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `v_daily_packing` AS SELECT
output_packing.pcs,
output_packing.tgl
FROM
output_packing
...
Sum(v_wip_sewing2.balance) AS balance,
