...
<body class="layout-top-nav sidebar-collapse" style="height: auto">
                            ...
                            <div class="card card-success card-outline">
                                <div class="card-header">
                                    <h3 class="card-title text-center">
                                        Calling For Machine Breakdown - 3rd Floor
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <div id="thirdCol"></div>
    ...
    <script>
        var thirdFloorColOld;
        var thirdFloorColNew;
        var thirdColTimer = [];
        var data3rdFloorOld;
        var rowTable;
        var data3rdFloor = "";
                    ...
                    data3rdFloorOld +=
                        "<div class='col-md-4'>" +
                            // "<a href='#' id='tip" + item.id_machine_breakdown.toString() + "'>" +
                                "<div id='thirdFloor" + item.id_machine_breakdown.toString() + "' class='" + (item.status == "Waiting..." ? "small-box bg-danger shadow" : "small-box bg-warning shadow") + "'>" +
                                    "<div class='inner'>" +
        ...
        function comparing3rdFloorData() {
            if (thirdFloorColOld.length < thirdFloorColNew.length) {
                ...
                data3rdFloorAdd +=
                    "<div class='col-md-4'>" +
                        // "<a href='#' id='tip" + item.id_machine_breakdown.toString() + "'>" +
                        "<div id='thirdFloor" + result[0].id_machine_breakdown.toString() + "' class='" + (result[0].status == "Waiting..." ? "small-box bg-danger shadow" : "small-box bg-warning shadow") + "'>" +
                            "<div class='inner'>" +
                ...
                $.each(thirdFloorColNew, function(i, itemNew) {
                    $.each(thirdFloorColOld, function(x, itemOld) {
                        if (itemNew.status != itemOld.status && itemNew.id_machine_breakdown == itemOld.id_machine_breakdown) {
                            ...
                            data3rdFloorChange +=
                                "<div id='thirdFloor" + itemOld.id_machine_breakdown.toString() + "' class='" + "small-box bg-warning shadow" + "'>" +
                                    "<div class='inner'>" +
