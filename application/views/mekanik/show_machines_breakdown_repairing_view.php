...
<head>
    ...
    <title>Production Report | Calling Mechanic</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="col-sm-12 text-center">
                    <h1 class="m-0 text-dark text-center">Mechanic Panel - Calling For Machine Breakdown </h1>
                </div><!-- /.col -->
    ...
    <script>
            ...
            $.ajax({
                ...
                $.each(data, function(i, item) {
                    ...
                    data1stFloorOld +=
                        ...
                        "<div id='firstFloor" + item.id_machine_breakdown.toString() + "' class='" + (item.status == "Waiting..." ? "info-box bg-danger shadow" : "info-box bg-warning shadow") + "'>" +
                        // "<span class='icon'><i class='" + (item.status == "Waiting..." ? "fa fa-flag" : "fa fa-wrench") + "'></i></span> " +
                        "<div class='info-box-content text-left'>" +
                        "<span class='info-box-text small'>" + item.machine_type + "</span>" +
                        "<span class='info-box-text small'>" + item.line + "</span>" +
        ...
        function comparing1stFloorData() {
            ...
            if (firstFloorColOld.length < firstFloorColNew.length) {
                ...
                data1stFloorAdd +=
                    ...
                    "<div id='firstFloor" + result[0].id_machine_breakdown.toString() + "' class='" + (result[0].status == "Waiting..." ? "info-box bg-danger shadow status" : "info-box bg-warning shadow status") + "'>" +
                    // "<span class='icon'><i class='fa fa-flag'></i></span> " +
                    "<div class='info-box-content text-left'>" +
                    "<span class='info-box-text small'>" + result[0].machine_type + "</span>" +
                    "<span class='info-box-text small'>" + result[0].line + "</span>" +
                ...
                $.each(firstFloorColNew, function(i, itemNew) {
                    $.each(firstFloorColOld, function(x, itemOld) {
                        if (itemNew.status != itemOld.status && itemNew.id_machine_breakdown == itemOld.id_machine_breakdown) {
                            ...
                            data1stFloorChange +=
                                // "<div id='firstFloor" + itemOld.id_machine_breakdown.toString() + "' class='bg-warning'>" +
                                // "<span class='icon'><i class='fa fa-wrench'></i></span> " +
                                "<div class='info-box-content text-left'>" +
                                "<span class='info-box-text small'>" + itemOld.machine_type + "</span>" +
                                "<span class='info-box-text small'>" + itemOld.line + "</span>" +
                                "<span class='info-box-text' id='" + itemOld.id_machine_breakdown + "' style='font-weight: bold;'></span>" +
                                "</div>";
                            // "</div>";
        ...
        function changeTooltip1(itmO) {
            ...
            Tipped.create('#tip' + itmO.id_machine_breakdown.toString(), $(
                "<span class='info-box-text text-left'>Merk: <b>" + itmO.machine_brand + "</b></span>" +
                "<span class='info-box-text text-left'>Type: <b>" + itmO.machine_type + "</b></span>" +
                "<span class='info-box-text'>S N: <b>" + itmO.machine_sn + "</b></span>" +
                "<span class='info-box-text'>Sympton: <b>" + itmO.sympton + "</b></span>" +
                "<span class='info-box-text'>Line: <b>" + itmO.line + "</b></span>" +
                "<span class='info-box-text'>Mechanic: <b>" + itmO.inisial + "</b></span>"
            ), {
                skin: 'green',
                fadeIn: 500,
                size: 'large',
            ...
            $.ajax({
                ...
                $.each(data, function(i, item) {
                    ...
                    data2ndFloorOld +=
                        ...
                        "<div class='col-md-4'>" +
                        "<a href='#' id='tip" + item.id_machine_breakdown.toString() + "'>" +
                        "<div id='secondFloor" + item.id_machine_breakdown.toString() + "' class='" + (item.status == "Waiting..." ? "info-box bg-danger shadow" : "info-box bg-warning shadow") + "'>" +
                        // "<span class='icon'><i class='" + (item.status == "Waiting..." ? "fa fa-flag" : "fa fa-wrench") + "'></i></span> " +
                        "<div class='info-box-content'>" +
                        "<span class='info-box-text small'>" + item.machine_type + "</span>" +
                        // "<span class='info-box-text'>" + item.machine_sn + "</span>" +
                        // "<span class='info-box-text'>" + item.sympton + "</span>" +
                        "<span class='small'>" + item.line + "</span>" +
                        "<span class='info-box-text' id='" + item.id_machine_breakdown + "' style='font-weight: bold;'></span>" +
        ...
        function comparing2ndFloorData() {
            ...
            if (secondFloorColOld.length < secondFloorColNew.length) {
                ...
                data2ndFloorAdd +=
                    "<div class='col-md-4'>" +
                    "<a href='#' id='tip" + result[0].id_machine_breakdown.toString() + "'>" +
                    "<div id='secondFloor" + result[0].id_machine_breakdown.toString() + "' class='" + (result[0].status == "Waiting..." ? "info-box bg-danger shadow status" : "info-box bg-warning shadow status") + "'>" +
                    // "<span class='icon'><i class='fa fa-flag'></i></span> " +
                    "<div class='info-box-content text-left'>" +
                    "<span class='info-box-text small'>" + result[0].machine_type + "</span>" +
                    "<span class='info-box-text small'>" + result[0].line + "</span>" +
                ...
                $.each(secondFloorColNew, function(i, itemNew) {
                    $.each(secondFloorColOld, function(x, itemOld) {
                        if (itemNew.status != itemOld.status && itemNew.id_machine_breakdown == itemOld.id_machine_breakdown) {
                            ...
                            itemOld.duration = itemNew.duration;
                            data2ndFloorChange +=
                                // "<div id='secondFloor" + itemOld.id_machine_breakdown.toString() + "' class='bg-warning'>" +
                                // "<span class='icon'><i class='fa fa-wrench'></i></span> " +
                                "<div class='info-box-content text-left'>" +
                                "<span class='info-box-text small'>" + itemOld.machine_type + "</span>" +
                                "<span class='info-box-text small'>" + itemOld.line + "</span>" +
                ...
                secondFloorColOld = $.grep(thirdFloorColOld, function(element, index) {
                    return element.id_machine_breakdown == onlyInOld[0].id_machine_breakdown;
                }, true);
            ...
            $.ajax({
                ...
                $.each(data, function(i, item) {
                    ...
                    data3rdFloorOld +=
                        ...
                        "<div class='col-md-4'>" +
                        "<a href='#' id='tip" + item.id_machine_breakdown.toString() + "'>" +
                        "<div id='thirdFloor" + item.id_machine_breakdown.toString() + "' class='" + (item.status == "Waiting..." ? "info-box bg-danger shadow" : "info-box bg-warning shadow") + "'>" +
                        // "<span class='icon'><i class='" + (item.status == "Waiting..." ? "fa fa-flag" : "fa fa-wrench") + "'></i></span> " +
                        "<div class='info-box-content'>" +
                        "<span class='info-box-text small'>" + item.machine_type + "</span>" +
                        // "<span class='info-box-text'>" + item.machine_sn + "</span>" +
        ...
        function comparing3rdFloorData() {
            if (thirdFloorColOld.length < thirdFloorColNew.length) {
                ...
                data3rdFloorAdd +=
                    "<div class='col-md-4'>" +
                    "<a href='#' id='tip" + result[0].id_machine_breakdown.toString() + "'>" +
                    "<div id='thirdFloor" + result[0].id_machine_breakdown.toString() + "' class='" + (result[0].status == "Waiting..." ? "info-box bg-danger shadow status" : "info-box bg-warning shadow status") + "'>" +
                    // "<span class='icon'><i class='fa fa-flag'></i></span> " +
                    "<div class='info-box-content text-left'>" +
                    "<span class='info-box-text small'>" + result[0].machine_type + "</span>" +
                    "<span class='info-box-text small'>" + result[0].line + "</span>" +
                ...
                var data3rdFloorChange = "";
                $.each(thirdFloorColNew, function(i, itemNew) {
                    $.each(thirdFloorColOld, function(x, itemOld) {
                        if (itemNew.status != itemOld.status && itemNew.id_machine_breakdown == itemOld.id_machine_breakdown) {
                            $('#thirdFloor' + itemOld.id_machine_breakdown.toString()).removeClass('bg-danger').addClass('bg-warning').empty();
                            // $('#thirdFloor' + itemOld.id_machine_breakdown.toString()).empty();
                            itemOld.status = "Repairing...";
                            itemOld.inisial = itemNew.inisial;
                            itemOld.duration = itemNew.duration;
                            data3rdFloorChange +=
                                // "<div id='thirdFloor" + itemOld.id_machine_breakdown.toString() + "' class='bg-warning'>" +
                                // "<span class='icon'><i class='fa fa-wrench'></i></span> " +
                                "<div class='info-box-content text-left'>" +
                                "<span class='info-box-text small'>" + itemOld.machine_type + "</span>" +
                                "<span class='info-box-text small'>" + itemOld.line + "</span>" +
                                ...
                                "</div>";
                            // "</div>";
                            thirdColTimer[itemOld.id_machine_breakdown] = '';

                            thirdColTimer[itemOld.id_machine_breakdown] = new easytimer.Timer();
                            thirdColTimer[itemOld.id_machine_breakdown].start({
                                precision: 'seconds',
                                startValues: {
                                    hours: parseInt(itemOld.duration.substr(0, 2)),
                                    minutes: parseInt(itemOld.duration.substr(3, 2)),
                            ...
                            thirdColTimer[itemOld.id_machine_breakdown].addEventListener('secondsUpdated', function(e) {
                                $("#" + itemOld.id_machine_breakdown.toString()).html(thirdColTimer[itemOld.id_machine_breakdown].getTimeValues().toString());
                            });

                            $('#thirdFloor' + itemOld.id_machine_breakdown.toString()).append(data3rdFloorChange);
                            //change tooltip
                            changeTooltip1(itemOld);
                        }
                    });
