...
<body class="layout-top-nav sidebar-collapse" style="height: auto">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 text-center">
                            <h1 class="m-0 text-dark text-center">Mechanic Panel - Machines Repairing </h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
    ...
    <script>
        ...
        function show1stFloorData() {
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url("Mekanik/ajax_get_1stfloor_repairing_data"); ?>',
                cache: false,
                dataType: 'json'
            }).done(function(data) {
                // firstFloorColOld = [];
                ...
                $.each(data, function(i, item) {
                    ...
                    data1stFloorOld +=
                        ...
                        "<div id='firstFloor" + item.id_machine_breakdown.toString() + "' class='info-box bg-warning shadow'>" +
        ...
        function comparing1stFloorData() {
            ...
            if (firstFloorColOld.length < firstFloorColNew.length) {
                ...
                data1stFloorAdd +=
                    ...
                    "<div id='firstFloor" + result[0].id_machine_breakdown.toString() + "' class='" + "info-box bg-warning shadow status>" +
        ...
        function createToolTip1() {
            $.each(firstFloorColOld, function(x, itm) {
                ...
                Tipped.create('#tip' + itm.id_machine_breakdown.toString(), $(
                    ...
                    "<span class='info-box-text'>Mechanic: <b>" + itm.inisial + "</b></span>"
                ), {
                    skin: 'green',
                    fadeIn: 500,
                    size: 'large',
        ...
        function show2ndFloorData() {
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url("Mekanik/ajax_get_2ndfloor_repairing_data"); ?>',
                cache: false,
                dataType: 'json'
            }).done(function(data) {
                secondFloorColOld = [];
                ...
                $.each(data, function(i, item) {
                    ...
                    data2ndFloorOld +=
                        ...
                        "<div class='col-md-4'>" +
                        "<a href='#' id='tip" + item.id_machine_breakdown.toString() + "'>" +
                        "<div id='secondFloor" + item.id_machine_breakdown.toString() + "' class='" + "info-box bg-warning shadow>" +
                        "<span class='icon'><i class='" + "fa fa-wrench" + "'></i></span> " +
        ...
        function show3rdFloorData() {
            $.ajax({
                type: 'GET',
                url: '<?php echo site_url("Mekanik/ajax_get_3rdfloor_repairing_data"); ?>',
                cache: false,
                dataType: 'json'
            }).done(function(data) {
                thirdFloorColOld = [];
                ...
                $.each(data, function(i, item) {
                    ...
                    data3rdFloorOld +=
                        ...
                        "<div class='col-md-4'>" +
                        "<a href='#' id='tip" + item.id_machine_breakdown.toString() + "'>" +
                        "<div id='thirdFloor" + item.id_machine_breakdown.toString() + "' class='" + "info-box bg-warning shadow>" +
                        "<span class='icon'><i class='" + "fa fa-wrench" + "'></i></span> " +
                        "<div class='info-box-content'>" +
                        "<span class='info-box-text'>" + item.machine_type + "</span>" +
                        // "<span class='info-box-text'>" + item.machine_sn + "</span>" +
        ...
        function comparing3rdFloorData() {
            if (thirdFloorColOld.length < thirdFloorColNew.length) {
                ...
                data3rdFloorAdd +=
                    "<div class='col-md-4'>" +
                    "<a href='#' id='tip" + result[0].id_machine_breakdown.toString() + "'>" +
                    "<div id='thirdFloor" + result[0].id_machine_breakdown.toString() + "' class='" + "info-box bg-warning shadow status" + "'>" +
                    "<span class='icon'><i class='fa fa-flag'></i></span> " +
                    "<div class='info-box-content text-left'>" +
                    "<span class='info-box-text'>" + result[0].machine_type + "</span>" +
                    "<span class='info-box-text'>" + result[0].line + "</span>" +
