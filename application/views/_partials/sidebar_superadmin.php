...
<aside class="main-sidebar sidebar-light-secondary elevation-4 bg-default-gradient">
  <!-- Brand Logo -->
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo site_url('size'); ?>" class="nav-link <?php echo ($this->uri->segment(1)=='size' ? 'active' : ''); ?>">
                <i class="fa fa-arrow-circle-right nav-icon"></i>
                <p>Master Size</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="<?php echo site_url('sam'); ?>" class="nav-link <?php echo ($this->uri->segment(1)=='sam' ? 'active' : ''); ?>">
                <i class="fa fa-arrow-circle-right nav-icon"></i>
                <p>Master SAM</p>
              </a>
            </li>            
