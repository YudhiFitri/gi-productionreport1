				...
				<li class="nav-item has-treeview">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item">
							...
							<a href="<?php echo site_url('cutting'); ?>" class="nav-link <?php if ($this->uri->uri_string() == 'cutting') {
																																							echo 'active';
																																						} ?>">
						...
						<li class="nav-item">
							<a href="<?php echo site_url('InputCutting'); ?>" class="nav-link <?php if ($this->uri->uri_string() == 'inputcutting') {
																																									echo 'active';
																																								} ?>">
								<i class="fa fa-arrow-circle-right nav-icon"></i>
						...
						<li class="nav-item">
							...
							<a href="<?php echo site_url('OutputCutting'); ?>" class="nav-link <?php if ($this->uri->uri_string() == 'outputcutting') {
																																										echo 'active';
																																									} ?>">
								<i class="fa fa-arrow-circle-right nav-icon"></i>
						...
						<!-- <li class="nav-item">
              <a href="<?php echo site_url('outputcutting/change_line'); ?>" class="nav-link <?php if ($this->uri->uri_string() == 'outputcutting/change_line') {
																																																echo 'active';
																																															} ?>">
                <i class="fa fa-arrow-circle-right nav-icon"></i>
                <p>Change Line Production</p>
						...
						<li class="nav-item">
							<a href="<?php echo site_url('cutting/ajax_reprint_bundle'); ?>" class="nav-link <?php if ($this->uri->uri_string() == 'cutting/ajax_reprint_bundle') {
																																																	echo 'active';
																																																} ?>">
								<!-- <i class="fa fa-arrow-circle-right nav-icon"></i> -->
						...
						<li class="nav-item">
							<a href="<?php echo site_url('cutting/ajax_reprint_molding_bundle'); ?>" class="nav-link <?php if ($this->uri->uri_string() == 'cutting/ajax_reprint_molding_bundle') {
																																																					echo 'active';
																																																				} ?>">
								<!-- <i class="fa fa-arrow-circle-right nav-icon"></i> -->
								<i class="fa fa-print nav-icon"></i>
						...
						<li class="nav-item">
							<a href="<?php echo site_url('cutting/ajax_reprint_panty_bundles'); ?>" class="nav-link <?php if ($this->uri->uri_string() == 'cutting/ajax_reprint_panty_bundles') {
																																																				echo 'active';
																																																			} ?>" class="nav-link">
								<!-- <i class="fa fa-arrow-circle-right nav-icon"></i> -->
								<i class="fa fa-print nav-icon"></i>
