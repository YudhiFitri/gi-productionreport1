						...
						<div class="col-12">
							<div class="card card-info card-outline">
								<div class="card-header">
									<h3 class="card-title">Summary Transfer Area (IN)</h3>
								</div>
								<div class="card-body">
									<table class="table table-hover table-striped table-bordered tableCursor" style="width:100%" id="tableTransferAreaSummaryIn">
										<thead>
											<tr>
												<th>ID</th>
												<th>Tanggal</th>
