...
<body class="hold-transition sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"><strong>VF</strong> Packing List </h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
			</div>
						...
						<div class="col-12">
							<div class="card card-info card-outline">
								<div class="card-header">
									<h3 class="card-title">Detail Packing List VF</h3>
								</div>
								<div class="card-body">
									<table class="table table-hover table-striped table-bordered" style="width:100%" id="tablePackingListDetailVF">
										<thead>
											<tr>
												<th>Tanggal</th>
												<th>PO</th>
								...
								<div class="card-footer">
									<a href="<?= site_url('PackingListVF') ?>" class="btn btn-success btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>
								</div>
							</div>
						</div>
					</div>
	...
	<script>
		$(document).ready(function() {
			$('#tablePackingListDetailVF').DataTable({
				dom: 'Bfrtip',
				buttons: [
					'excel', 'print'
				]
