...
<body class="hold-transition sidebar-mini">
						...
						<div class="col-12">
							<div class="card card-info card-outline">
								<div class="card-header">
									<h3 class="card-title">Cek Posisi ORC</h3>
								</div>
								<div class="card-body">
									<table class="table table-hover table-striped table-bordered tableCursor" style="width:100%" id="tableCekPosisiKarton">
										<thead>
											<tr>
												<th>ORC</th>
												<th>PO</th>
	...
	<script>
		$(document).ready(function() {
			...
			var tableCekPosisiKarton = $('#tableCekPosisiKarton').DataTable();
